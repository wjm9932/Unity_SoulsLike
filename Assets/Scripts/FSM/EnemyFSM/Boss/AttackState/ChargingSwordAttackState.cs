...
namespace BossEnemyFSM
{
    public class ChargingSwordAttackState : BossEnemyPatternState
    {
        ...
        public override void OnAnimationTransitionEvent()
        {
            ...
            SoundManager.Instance.Play3DSoundEffect(SoundManager.SoundEffectType.BOSS_CHARGE_ATTACK, 0.3f, sm.owner.transform.position, Quaternion.identity, sm.owner.gameObject.transform);
